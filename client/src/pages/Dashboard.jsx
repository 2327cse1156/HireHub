...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Redirect to manage-jobs on initial dashboard load if companyData exists
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navbar */}
      <header className="shadow py-4 bg-white z-20">
